...
# biblioteca para trabalhar com as std_msgs (strings, float, etc)
from std_msgs.msg import String, Float32
# biblioteca para trabalhar com  as sensor_msgs (imagens)
...
def yaw_callback(ros_image):
    ...
    try:
        ...
        flag_moments, y_pts_moments, x_pts_moments = ltools.direction_by_moments(
...
def main():
    ...
    rospy.Subscriber("/downward_cam/camera/image", Image, yaw_callback)
